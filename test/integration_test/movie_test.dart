...
void main() {
  ...
  group('Movie Flow Tests', () {
    testWidgets('Complete movie interaction flow test',
      ...
      //Verify we're on HomePage and find first movie
      ...
      // Find and open first cast member profile
      ...
      //Verify the movie is present in liked movies
